...
loghandler = {
    error: {
        status: false,
        code: 503,
        message: '❕ Service Unavailable, x_x',
        maintanied_by: `${creator}`
    },
    noturl: {
    	status: false,
    	code: 403,
    	message: '❕ Link Mungkin Tidak Benar Atau Error :/',
    	maintanied_by: `${creator}`
    },
    notfound: {
    	status: false,
    ...
    notid: {
    	status: false,
    	code: 404,
    	message: '❕ ID Atau Zone Mungkin Tidak Valid',
    	maintanied_by: `${creator}`
    },
    redy: {
    	status: false,
    	code: 403,
    	message: '❕ Sudah Di Gunakan',
    	maintanied_by: `${creator}`
    },
    emoji: {
	status: false,
	code: 403,
	message: '❕ Tidak Menemukan Emoji',
	maintanied_by: `${creator}`
}
