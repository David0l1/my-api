...
creator = 'Yourself' // Nama 
port = 8080 //port host
LimitApikey = 100 // Limit Apikey default

//___________ ┏  Database Mongodb Setting  ┓ ___________\\

keymongodb = 'mongodb+srv://David0l1:36011@cluster0.rpgbtss.mongodb.net/?retryWrites=true&w=majority' //example "mongodb+srv://user:password@name_database.mongodb.net/?retryWrites=true&w=majority";
...
sendpwmail = 'kcaptsojlsuvwgjj' // Password Email SMTP
domain = 'api.onee.eu.org'// domain website tanpa http or https
...
loghandler = {
    ...
    emoji: {
	    status: false,
	    code: 403,
	    message: 'Emoji No Supported',
	    maintanied_by: `${creator}`
   },
    register: {
	    status: false,
	    code: 403,
	    message: 'Register To Conttinue!',
  },
   verify: {
	    status: false,
	    code: 403,
